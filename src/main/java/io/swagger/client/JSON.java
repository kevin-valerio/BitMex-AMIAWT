...
public class JSON {
    ...
    private static Class getClassByDiscriminator(Map classByDiscriminatorValue, String discriminatorValue) {
        ...
        if (null == clazz) {
            throw new IllegalArgumentException("cannot determine io.swagger.client.model class of name: <" + discriminatorValue + ">");
        }
        return clazz;
    }
    ...
    /**
     * Serialize the given Java object into io.swagger.client.JSON string.
     *
     * @param obj Object
     * @return String representation of the io.swagger.client.JSON
     */
    ...
    /**
     * Deserialize the given io.swagger.client.JSON string to Java object.
     *
     * @param <T>        Type
     * @param body       The io.swagger.client.JSON string
    ...
    public <T> T deserialize(String body, Type returnType) {
        try {
            ...
            // Fallback processing when failed to parse io.swagger.client.JSON form response body:
