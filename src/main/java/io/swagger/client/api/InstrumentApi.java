...
public class InstrumentApi {
     ...
     * @param startTime Starting date filter for results. (optional)
     * @param endTime   Ending date filter for results. (optional)
     * @return io.swagger.client.ApiResponse&lt;List&lt;Instrument&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Instrument>> instrumentGetWithHttpInfo(String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<Instrument>>() {
        }.getType();
     ...
     * This endpoint is useful for determining which pairs are live. It returns two arrays of   strings. The first is intervals, such as &#x60;[\&quot;BVOL:daily\&quot;, \&quot;BVOL:weekly\&quot;, \&quot;XBU:daily\&quot;, \&quot;XBU:monthly\&quot;, ...]&#x60;. These identifiers are usable in any query&#39;s &#x60;symbol&#x60; param. The second array is the current resolution of these intervals. Results are mapped at the same index.
     *
     * @return io.swagger.client.ApiResponse&lt;InstrumentInterval&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InstrumentInterval> instrumentGetActiveIntervalsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<InstrumentInterval>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @param startTime Starting date filter for results. (optional)
     * @param endTime   Ending date filter for results. (optional)
     * @return io.swagger.client.ApiResponse&lt;List&lt;IndexComposite&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<IndexComposite>> instrumentGetCompositeIndexWithHttpInfo(Double account, String symbol, String filter, String columns, BigDecimal count, BigDecimal start, Boolean reverse, OffsetDateTime startTime, OffsetDateTime endTime) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<IndexComposite>>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
