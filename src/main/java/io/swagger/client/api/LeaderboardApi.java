...
public class LeaderboardApi {
     ...
     *
     * @param method Ranking type. Options: \&quot;notional\&quot;, \&quot;ROE\&quot; (optional, default to notional)
     * @return io.swagger.client.ApiResponse&lt;List&lt;Leaderboard&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Leaderboard>> leaderboardGetWithHttpInfo(String method) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<Leaderboard>>() {
        }.getType();
     ...
     * Get your alias on the leaderboard.
     *
     * @return io.swagger.client.ApiResponse&lt;InlineResponse2001&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
